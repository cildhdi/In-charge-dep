...
const menus: string[] = ['merchant-register', 'merchant-manage', 'customer-manage'];
  ...
  return (
    <Layout style={{ height: '100%' }}>
      <Header style={{ position: 'fixed', zIndex: 1, width: '100%' }}>
        ...
        >
          <Menu.Item key={menus[0]}><Link to={menus[0]}>商户注册</Link></Menu.Item>
          <Menu.Item key={menus[1]}><Link to={menus[1]}>商户管理</Link></Menu.Item>
